...
"""
    ...
    status_bg_colors = [status_colors.get(status, '#6c757d') for status in status_labels]

    type_labels = list(type_counts.keys())
    type_data = list(type_counts.values())

    assignee_labels = list(assignee_counts.keys())[:10]  # Top 10
    assignee_data = list(assignee_counts.values())[:10]

    product_labels = list(product_tag_counts.keys())
    product_data = list(product_tag_counts.values())
...
"""
    ...
    # Product tag bar chart
    if product_tag_counts:
        html += f"""
                <div class="chart-card">
                    <h3>Product Tags</h3>
                    <canvas id="productBarChart" class="chart-canvas"></canvas>
                </div>
"""
...
"""
    ...
    <script>
        ...
        const pieColors = [
            ...
            '#fbc2eb', '#a6c1ee', '#fccb90', '#d57eeb', '#e0c3fc'
        ];
"""
